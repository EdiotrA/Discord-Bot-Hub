...
const categories = {
  ...
  Economy: {
    emoji: '🪙',
    description: 'Coins, rewards, wagers, and leaderboards',
    commands: [
      { name: 'economy balance', description: 'View a wallet balance' },
      { name: 'economy daily', description: 'Claim daily coins' },
      { name: 'economy pay', description: 'Pay coins to another member' },
      { name: 'economy coinbet', description: 'Bet on heads or tails' },
      { name: 'economy dicebet', description: 'Bet on high or low dice' },
      { name: 'economy blackjack', description: 'Play quick blackjack' },
      { name: 'economy roulette', description: 'Bet on an exact roulette number' },
      { name: 'economy leaderboard', description: 'View the currency leaderboard' },
    ],
  },
  Mog: {
    emoji: '😎',
    description: 'Mog profiles, challenges, items, and rankings',
    commands: [
      { name: 'mog profile', description: 'View a Mog profile' },
      { name: 'mog challenge', description: 'Challenge another member' },
      { name: 'mog shop', description: 'Browse Mog items' },
      { name: 'mog inventory', description: 'View owned Mog items' },
      { name: 'mog leaderboard', description: 'View the Mog leaderboard' },
    ],
  },
  Utility: {
    emoji: '🔧',
    ...
    commands: [
      ...
      { name: 'panel', description: 'Post the click-ready Loopy command hub [Admin]' },
      { name: 'assistant', description: 'Ask Loopy for coding, UI, debugging, or server help' },
      { name: 'verifypanel', description: 'Post the click-ready Roblox verification panel [Admin]' },
